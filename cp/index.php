...
<?php include($basePath.'modules/modules.inc.php'); ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="utf-8">
    ...
    <!--[if lt IE 9]>
    <script src="<?=$basePath?>resources/js/ie8-responsive-file-warning.js"></script>
    <![endif]-->
  ...
  <body>
    ...
    <div class="container">
        ...
        <!-- #content-->
        <div class="content">
          <?php include('modules/'.$page['module'].'.inc.php') ?>
        </div>
        <!-- / #content-->
      <!-- #footer-->
